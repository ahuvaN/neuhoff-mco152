...
public class AirplaneSeatsTest {
	...
	@Test
	/**
	 * Test the output of toString() on an partially filled plane. Do not modify this method.
	 */
	public void testToStringWithNotFullPlane() throws AlreadyReservedException,
			SeatOutOfBoundsException {
		AirplaneSeats seats = new AirplaneSeats(5, 4);
		seats.reserveAll("A1", "D1", "A2", "A3", "B3", "C3", "A4", "B4", "A5");
		Assert.assertEquals("  ABCD\n" + 
							"1 #oo#\n" + 
							"2 #ooo\n" + 
							"3 ###o\n" + 			
	...
	public void testReserveGroupOnEmptyPlane() throws NotEnoughSeatsException {
		AirplaneSeats seats = new AirplaneSeats(3, 4);
		ArrayList<String> reserved = seats.reserveGroup(2);
		ArrayList<String> result = new ArrayList<String>();
		result.add("A1");
		result.add("B1");
		Assert.assertEquals(result, reserved);
	}
